            ...
            <section className="relative bg-gradient-to-r from-blue-900 to-indigo-800 text-white py-20 md:py-28">
                            ...
                            <form onSubmit={handleSearch} className="flex flex-col md:flex-row gap-4">
                                <div className="flex-grow">
                                    <input
                                        ...
                                        className="w-full px-4 py-3 text-gray-700 rounded border focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                        value={searchTerm}
                                ...
                                <button
                                    type="submit"
                                    className="bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-3 px-6 rounded transition duration-300"
                                >
                                    Search Cars
                                </button>
                            </form>
                ...
                <div className="absolute bottom-0 left-0 right-0 h-16">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="w-full h-full">
                        <path fill="#ffffff" fillOpacity="1" d="M0,128L80,144C160,160,320,192,480,186.7C640,181,800,139,960,128C1120,117,1280,139,1360,149.3L1440,160L1440,320L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path>
                    </svg>
                </div>
            </section>
            ...
            <div className="container mx-auto mt-10 px-4">
                <div className="flex flex-wrap justify-center mb-8">
                    <button
                        ...
                        className={`mx-2 mb-2 px-6 py-2 rounded-full text-lg font-medium transition-colors ${activeView === 'about'
                    ...
                    <button
                        ...
                        className={`mx-2 mb-2 px-6 py-2 rounded-full text-lg font-medium transition-colors ${activeView === 'browse'
                            ? 'bg-indigo-600 text-white'
                            : 'bg-gray-200 text-gray-800 hover:bg-gray-300'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`mx-2 mb-2 px-6 py-2 rounded-full text-lg font-medium transition-colors ${activeView === 'how'
                            ? 'bg-indigo-600 text-white'
                            : 'bg-gray-200 text-gray-800 hover:bg-gray-300'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`mx-2 mb-2 px-6 py-2 rounded-full text-lg font-medium transition-colors ${activeView === 'testimonials'
                            ? 'bg-indigo-600 text-white'
                            : 'bg-gray-200 text-gray-800 hover:bg-gray-300'
                            }`}
                    >
            ...
            <div className="container mx-auto px-4 pb-16">
                ...
                {activeView === 'about' && (
                    <div className="space-y-16">
                        ...
                        <section className="bg-white rounded-xl shadow-md p-8 text-center">
                            <h2 className="text-3xl font-bold mb-6 text-gray-800">Welcome to CrucialCars</h2>
                        ...
                        <section>
                            <div className="flex justify-between items-center mb-8">
                                ...
                                <Link to="/cars" className="text-indigo-600 hover:text-indigo-800 font-medium">
                                    View All Cars →
                                </Link>
                            </div>
                            ...
                            {testimonialsLoading ? (
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                    {testimonials.slice(0, 3).map(testimonial => (
                                        <div key={testimonial._id || testimonial.id} className="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-md mb-8">
                            ...
                            <div className="flex justify-end mt-4">
                                <button
                                    ...
                                    className="bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium py-2 px-4 rounded-md transition duration-300 mr-2"
                                >
                                    Reset Filters
                                </button>
                                <button
                ...
                {activeView === 'how' && (
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-3xl font-bold mb-10 text-center">How CrucialCars Works</h2>

                        <div className="space-y-12">
                            {steps.map((step, index) => (
                                <div key={step.id} className="flex flex-col md:flex-row items-center">
                                    <div className="md:w-1/4 flex justify-center mb-6 md:mb-0">
                                        <div className="w-20 h-20 bg-indigo-100 rounded-full flex items-center justify-center text-3xl text-indigo-600">
                                            {step.icon}
                                        </div>
                                    </div>
                                    <div className="md:w-3/4">
                                        <h3 className="text-xl font-bold mb-2">
                                            <span className="text-indigo-600 mr-2">Step {index + 1}:</span> {step.title}
                                        </h3>
                        ...
                        <div className="mt-16 text-center">
                            <h3 className="text-2xl font-semibold mb-6">Ready to find your perfect car?</h3>
                            <button
                                onClick={() => setActiveView('browse')}
                ...
                {activeView === 'testimonials' && (
                    <div className="max-w-5xl mx-auto">
                        ...
                        {testimonialsLoading ? (
                            ...
                            <div className="grid grid-cols-1 gap-10">
                                {testimonials.map(testimonial => (
                                    <div key={testimonial._id || testimonial.id} className="bg-white p-8 rounded-xl shadow-md">
                        ...
                        <div className="mt-16 bg-indigo-50 p-8 rounded-xl text-center">
                            <h3 className="text-2xl font-semibold mb-4">Ready to experience CrucialCars?</h3>
                            <p className="text-gray-700 mb-6">Join our satisfied customers and find your perfect drive today.</p>
                            <div className="flex flex-col sm:flex-row justify-center gap-4">
                                ...
                                <Link
                                    to="/register"
                                    className="bg-white hover:bg-gray-100 text-indigo-600 font-medium py-3 px-6 rounded-lg border border-indigo-600 transition duration-300"
                                >
                                    Create Account
                                </Link>
                            </div>
                ...
                <section className="bg-indigo-100 py-16">
                    <div className="container mx-auto px-4 text-center">
                        ...
                        <div className="flex justify-center gap-4">
                            <Link to="/register" className="bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-3 px-8 rounded-lg transition duration-300">
                                List Your Car
                            </Link>
                            <Link to="/browse" className="bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium py-3 px-8 rounded-lg transition duration-300">
                                Explore Cars
                            </Link>
                        </div>
                    </div>
